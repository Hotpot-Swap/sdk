import { ChainId, CurrencyAmount, Price, Token } from '@hotpot-swap/core-sdk'
...
describe('Limit Order', () => {
  it('should create Limit Order', async () => {
    ...
    let tokenB = new Token(ChainId.MATIC, '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9', 18, 'HOTPOT')
  ...
  it('should create limit order and return data to sign', () => {
    ...
    const tokenB = new Token(ChainId.KOVAN, '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9', 18, 'HOTPOT')
